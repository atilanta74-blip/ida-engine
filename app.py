...
# --- CSICSA & HIGH-TECH STÍLUS (JAVÍTOTT, KONTRASZTOS MEZŐKKEL) ---
st.markdown(
    """
<style>
    ...
    /* BEMENETI MEZŐK ÉS SZÖVEGDOBOZ JAVÍTÁSA: ÉLES FEHÉR BETŰK, SÖTÉT HÁTTÉR */
...
with c_left:
  ...
  hiba_rovid = st.text_input(
      "Hiba megnevezése", value="CT érzékelő kábel törés"
  )
...
with c_right:
  ...
  jegyzet_szoveg = st.text_area(
      ...
      height=188,
      value=(
          "A SL2 2-es manipulátor ct érzékelő szenzor kábel a sok mozgástól"
          " megtörött . A törés érzéklehető volt. Csere kábel nincs ,ezért"
          " kábelkötegelővel rögzítve lett.\n"
          "Akció: kábel csatlakozóval beazonosítás, SAP igénylés, Rendelés. "
          " Felelős: Nagy Attila.  Határidő :2026.10.15.\n"
          "Másnap a raktárban megtaláltuk a szenzor kábelt .SAP: 2033358"
      ),
  )


# --- DOKUMENTUM GENERÁLÓ MOTOR (100% GYÁRI FORMÁTUM, CSAK JANÓCZKI M A LÁBLÉCBEN) ---
def general_hivatalos_docx(gep, hiba, datum, felelos, jegyzet):
  ...
  crit_rows = [
      (
          "Tisztaság\n(A részegység elég tiszta, hogy ellenőrizhető legyen?)",
          "1. Tiszta, lerakódásmentes felület.",
          "1. Megfelelő felületi tisztaság.",
          "1. Nincs hiányosság.",
          "1. Nem releváns.",
          "1. Standard CIL tisztítás fenntartása.",
      ),
      (
          "Meghúzottság\n(A kötőelemek megfelelően meg vannak húzva?)",
          "1. Kötőelemek előírt nyomatékkal rögzítve.",
          "1. Csavarok és rögzítők stabilak.",
          "1. Nincs hiányosság.",
          "1. Nem releváns.",
          "1. Éves mechanikai ellenőrzés.",
      ),
      (
          "Kenés\n(A berendezés a kenési terv szerint kenve?)",
          "1. Megfelelő kenőanyag és mennyiség.",
          "1. Csapágyazások és vezetők kenve.",
          "1. Nem releváns szenzorhibánál.",
          "1. Nem releváns.",
          "1. Kenési standard fenntartása.",
      ),
      (
          "Karbantartás\n(Szükséges elemek előírás szerint karbantartva?)",
          "1. Dinamikus mozgó kábelek periodikus állapotfelmérése és cseréje.",
          "1. A szenzorkábel nem szerepelt megelőző ellenőrzési ciklusban.",
          "1. Hiányzik a mozgó kábelek ciklikus felmérése és megelőző cseréje.",
          (
              "1. A PM terv nem tér ki külön a hajlított kábelek fáradásos"
              " vizsgálatára."
          ),
          (
              "1. Kábelek felvétele a negyedéves PM listára.\nFelelős:"
              f" {felelos}, Határidő: 2026.10.15."
          ),
      ),
      (
          "Környezet\n(Előírásoknak megfelelő környezet?)",
          "1. Normál üzemi hőmérséklet, vegyszermentesség.",
          "1. Normál gyártócsarnoki környezet.",
          "1. Nincs hiányosság.",
          "1. Nem releváns.",
          "1. Környezeti feltételek fenntartása.",
      ),
      (
          "Működtetés\n(Munkafolyamatokat következetesen betartják?)",
          "1. Standard kezelői manipulációs pálya.",
          "1. Kezelők az előírás szerint üzemeltetik.",
          "1. Nincs kezelői hiba.",
          "1. Nem releváns.",
          "1. Munkautasítás fenntartása.",
      ),
      (
          "Specifikáció\n(Határértékeken belül működtetik?)",
          "1. Névleges határokon belüli sebesség.",
          "1. Gyári paramétereken belüli üzem.",
          "1. Nincs határérték-túllépés.",
          "1. Nem releváns.",
          "1. Paraméterek felügyelete.",
      ),
      (
          "Működés\n(Végez nem megfelelő műveletet?)",
          "1. Hibátlan pozícióérzékelés, zavartalan ciklus.",
          "1. CT jelvesztés miatt manipulátor pozícióhiba és sorleállás.",
          "1. Jelátviteli hiba a CT szenzor törött kábele miatt.",
          "1. Kábeltörés a dinamikus mozgási zónában.",
          f"1. Ideiglenes rögzítés után új kábel beépítése.\nFelelős: {felelos}",
      ),
      (
          "Telepítés\n(Telepítéskor követték az útmutatót?)",
          "1. Védőcsőben vezetett kábelezés, megfelelő rádiusszal.",
          "1. Túl szűk hajlítási rádiusz, pontszerű terhelés.",
          "1. Elégtelen hajlítási sugár a mozgó csuklópontnál.",
          "1. A rögzítés nem adott elég mozgásteret a ciklikus forgáshoz.",
          "1. Új kábelvezetés kialakítása nagyobb ívvel és"
          f" védőcsővel.\nFelelős: {felelos}, Hat.: 2026.10.15.",
      ),
      (
          "Összeszerelés\n(Alkatrészek megfelelően illeszkednek?)",
          "1. Akadálymentes mozgás dörzsölődés nélkül.",
          "1. Külső dörzsölődés nem látható.",
          "1. Nincs hiányosság.",
          "1. Nem releváns.",
          "1. Standard állapot fenntartása.",
      ),
      (
          "Gyártás\n(Rajzoknak megfelelő alkatrészek?)",
          "1. Dinamikus robotmozgásra méretezett kábeltípus.",
          "1. Standard kábel került beépítésre, ciklusszám végén kifáradt.",
          "1. Kábel fáradási élettartama lejárt.",
          "1. Dinamikus igénybevétel miatti rézér-fáradás.",
          "1. Gyári magas flexibilitású kábel alkalmazása (SAP: 2033358).",
      ),
      (
          "Tervezés\n(Alkatrészek megbízhatóan működnek?)",
          "1. Megbízható, törésmentes villamos jelátvitel.",
          (
              "1. Sok mozgástól a kábel mechanikusan megtört, kézzel"
              " érzékelhető volt."
          ),
          "1. CT szenzorkábel fizikai törése.",
          "1. Fárasztó hajlítófeszültség a kilépési pontnál.",
          "1. Kábelcsere és rögzítési tehermentesítés.",
      ),
      (
          "Javítás\n(Üzemzavar elhárítása elvárt idő alatt?)",
          "1. Azonnali alkatrész-elérhetőség és csere.",
          (
              "1. Cserekábel a gépnél nem állt rendelkezésre; kötegelővel"
              " ideiglenesen stabilizálva."
          ),
          "1. Nem volt azonnali kábel kéznél; SAP azonosító hiányzott.",
          (
              "1. Cikkszám nem szerepelt a gép alkatrészlistáján; másnap lett"
              " meg (SAP: 2033358)."
          ),
          "1. Kötegelős rögzítés kész.\n2. Raktárban megtalálva (SAP:"
  ...
  p_defs = [
      (
          f"1. ÁG: MŰSZAKI ÁG\nA {gep} {hiba} miatt leállt, a kábel a dinamikus"
          " mozgástól megtört."
      ),
      (
          "2. ÁG: KARBANTARTÁSI ÁG\nNem volt megelőzve a kábeltörés a korábbi"
          " megelőző karbantartási (PM) ciklusok során."
      ),
      (
          "3. ÁG: ALKATRÉSZ-ELLÁTÁSI ÁG\nAz üzemzavar pillanatában nem állt"
          " rendelkezésre azonnali cserekábel a gép mellett."
      ),
      "",
      "",
  ]
  whys = [
      [
          (
              "Miért állt le a manipulátor?\n-> CT érzékelő nem adott jelet a"
              " vezérlésnek."
          ),
          (
              "Miért nem előztük meg a hibát?\n-> Nem volt állapotellenőrzés a"
              " mozgó kábeleken."
          ),
          (
              "Miért kötegelővel javítottuk?\n-> A helyszínen nem volt azonnali"
              " cserealkatrész."
          ),
          "",
          "",
      ...
      [
          (
              ...
              " mechanikusan eltörtek."
          ),
          (
              "Miért nem ellenőriztük a kábelt?\n-> A szenzorkábel nem szerepelt"
              " a PM ellenőrzőlistán."
          ),
          (
              "Miért nem vettünk ki raktárból?\n-> A pontos SAP cikkszám azonnal"
              " nem volt ismert."
          ),
          "",
          "",
      ...
      [
          (
              "Miért tört meg a kábel?\n-> A hajlítási rádiusz túl szűk volt,"
              " pontszerű terhelést kapott."
          ),
          (
              "Miért nem szerepelt a PM-ben?\n-> Nem volt része a dinamikus"
              " kábelkorbács-fáradás vizsgálata."
          ),
          (
              "Miért nem volt kéznél cikkszám?\n-> Nem volt hozzárendelve a gép"
              " alkatrészlistájához (BOM)."
          ),
          "",
          "",
      ],
      [
          (
              "Miért volt szűk a hajlítási ív?\n-> A rögzítés és vezetés nem"
              " adott elég mozgásteret a forgáshoz."
          ),
          (
              "Miért nem része a standardnak?\n-> Gépátadáskor nem kezelték"
              " kritikus kopó alkatrészként."
          ),
          (
              "Hogyan lett beazonosítva?\n-> Másnap raktárban minta alapján"
              " beazonosítva: SAP 2033358."
          ),
          "",
          "",
      ],
      [
          (
              "GYÖKÉROK:\nA kábelvezetés nem biztosított tehermentesítő ívet a"
              " hajlítási zónában, ami rézér-fáradáshoz vezetett."
          ),
          (
              "GYÖKÉROK:\nA PM rendszerből hiányzik a dinamikusan mozgó"
              " flexibilis kábelek megelőző csereciklusa."
          ),
          (
              "GYÖKÉROK:\nA kritikus alkatrész SAP azonosítója hiányzott a gép"
              " törzsadat-jegyzékéből (BOM)."
          ),
          "",
          "",
      ],
...
if st.button("⚡ INTELLIGENS ELEMZÉS & DOKUMENTUM GENERÁLÁSA"):
  ...
  steps = [
      ...
      (
          "B-ME szabványú lábléc és regisztráció hitelesítése (Janóczki"
          " M)..."
      ),
  ...
  docx_file = general_hivatalos_docx(
      gep_nev, hiba_rovid, datum_val, felelos_val, jegyzet_szoveg
  )
  status_text.markdown(
      "✅ **Az elemzés sikeresen lefutott, a dokumentum készen áll!**"
  )
